...
public class EndgameTab extends Fragment {
    private static final String TAG = "EndgameTab";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        this.root = inflater.inflate(R.layout.endgame_tab, container, false); //creates UI
        ...
        this.setupButton(R.id.endgame_hab_level_0_int, R.id.endgame_hab_level_0_plus, 0, 1, 1);
        this.setupButton(R.id.endgame_hab_level_0_int, R.id.endgame_hab_level_0_minus, 0, 1, -1);
        this.setupButton(R.id.endgame_hab_level_1_int, R.id.endgame_hab_level_1_plus, 0, 1, 1);
        this.setupButton(R.id.endgame_hab_level_1_int, R.id.endgame_hab_level_1_minus, 0, 1, -1);
        this.setupButton(R.id.endgame_hab_level_2_int, R.id.endgame_hab_level_2_plus, 0, 1, 1);
        this.setupButton(R.id.endgame_hab_level_2_int, R.id.endgame_hab_level_2_minus, 0, 1, -1);
        this.setupButton(R.id.endgame_hab_level_3_int, R.id.endgame_hab_level_3_plus, 0, 1, 1);
        this.setupButton(R.id.endgame_hab_level_3_int, R.id.endgame_hab_level_3_minus, 0, 1, -1);
        this.setupButton(R.id.endgame_fell_int, R.id.endgame_fell_plus, 0, 1, 1);
        this.setupButton(R.id.endgame_fell_int, R.id.endgame_fell_minus, 0, 1, -1);
        this.setupButton(R.id.endgame_was_lifted_int, R.id.endgame_was_lifted_plus, 0, 1, 1);
        this.setupButton(R.id.endgame_was_lifted_int, R.id.endgame_was_lifted_minus, 0, 1, -1);
        this.setupButton(R.id.endgame_lifted_others_int, R.id.endgame_lifted_others_plus, 0, 2, 1);
        this.setupButton(R.id.endgame_lifted_others_int, R.id.endgame_lifted_others_minus, 0, 2, -1);
        return this.root;
    }
