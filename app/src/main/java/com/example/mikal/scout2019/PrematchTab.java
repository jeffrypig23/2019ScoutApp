...
public class PrematchTab extends Fragment {
    private static final String TAG = "PrematcbTab";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        this.root = inflater.inflate(R.layout.prematch_tab, container, false); //creates UI
        ...
        this.setupButton(R.id.prematch_hatch_panel_start_int, R.id.prematch_hatch_panel_start_plus, 0, 1, 1);
        this.setupButton(R.id.prematch_hatch_panel_start_int, R.id.prematch_hatch_panel_start_minus, 0, 1, -1);
        this.setupButton(R.id.prematch_cargo_start_int, R.id.prematch_cargo_start_plus, 0, 1, 1);
        this.setupButton(R.id.prematch_cargo_start_int, R.id.prematch_cargo_start_minus, 0, 1, -1);
        this.setupButton(R.id.prematch_hab_1_start_int, R.id.prematch_hab_1_start_plus, 0, 1, 1);
        this.setupButton(R.id.prematch_hab_1_start_int, R.id.prematch_hab_1_start_minus, 0, 1, -1);
        this.setupButton(R.id.prematch_hab_2_start_int, R.id.prematch_hab_2_start_plus, 0, 1, 1);
        this.setupButton(R.id.prematch_hab_2_start_int, R.id.prematch_hab_2_start_minus, 0, 1, -1);
        return this.root;
    }
