...
public class TeleRocketTab extends Fragment {
    private static final String TAG = "TeleRocketTab";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        this.root = inflater.inflate(R.layout.tele_rocket_tab, container, false); //creates UI
        ...
        this.setupButton(R.id.tele_hp_rocket_score_low_int, R.id.tele_hatch_panel_rocket_score_low_plus, 0, 100, 1);
        this.setupButton(R.id.tele_hp_rocket_score_low_int, R.id.tele_hatch_panel_rocket_score_low_minus, 0, 100, -1);
        this.setupButton(R.id.tele_hp_rocket_score_medium_int, R.id.tele_hatch_panel_rocket_score_medium_plus, 0, 100, 1);
        this.setupButton(R.id.tele_hp_rocket_score_medium_int, R.id.tele_hatch_panel_rocket_score_medium_minus, 0, 100, -1);
        this.setupButton(R.id.tele_hp_rocket_score_high_int, R.id.tele_hatch_panel_rocket_score_high_plus, 0, 100, 1);
        this.setupButton(R.id.tele_hp_rocket_score_high_int, R.id.tele_hatch_panel_rocket_score_high_minus, 0, 100, -1);
        this.setupButton(R.id.tele_cargo_rocket_score_low_int, R.id.tele_cargo_rocket_score_low_plus, 0, 100, 1);
        this.setupButton(R.id.tele_cargo_rocket_score_low_int, R.id.tele_cargo_rocket_score_low_minus, 0, 100, -1);
        this.setupButton(R.id.tele_cargo_rocket_score_medium_int, R.id.tele_cargo_rocket_score_medium_plus, 0, 100, 1);
        this.setupButton(R.id.tele_cargo_rocket_score_medium_int, R.id.tele_cargo_rocket_score_medium_minus, 0, 100, -1);
        this.setupButton(R.id.tele_cargo_rocket_score_high_int, R.id.tele_cargo_rocket_score_high_plus, 0, 100, 1);
        this.setupButton(R.id.tele_cargo_rocket_score_high_int, R.id.tele_cargo_rocket_score_high_minus, 0, 100, -1);
        return this.root;
    }
